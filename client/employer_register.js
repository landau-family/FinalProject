$(document).ready(function() {
    // Fetch the residential areas from the server and populate the dropdown list
    $.get('/get_residential_areas', function(response) {
      const residentialAreas = response; // Assuming the response is an array of residential areas
      const dropdown = $('#residentialArea');
      $.each(residentialAreas, function(index, area) {
        dropdown.append($('<option>').text(area).val(area));
      });
    });
